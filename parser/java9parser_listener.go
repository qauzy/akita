...
// Java9ParserListener is a complete listener for a parse tree produced by Java9Parser.
type Java9ParserListener interface {
	...
	// EnterOrdinaryCompilation is called when entering the ordinaryCompilation production.
	EnterOrdinaryCompilation(c *OrdinaryCompilationContext)

	// EnterModularCompilation is called when entering the modularCompilation production.
	EnterModularCompilation(c *ModularCompilationContext)
	...
	// ExitOrdinaryCompilation is called when exiting the ordinaryCompilation production.
	ExitOrdinaryCompilation(c *OrdinaryCompilationContext)

	// ExitModularCompilation is called when exiting the modularCompilation production.
	ExitModularCompilation(c *ModularCompilationContext)
